"""Sweep stale direction shift on top of ToxSkew-v2 (531.69 baseline)."""
import subprocess
import re
...
# Sweep stale_coef and attract_pct
print("=== Stale direction shift sweep ===")
print("(baseline without stale shift: 531.69)\n")
for coef in [500, 1000, 1500, 2000, 3000, 5000]:
    for attract in [0, 50, 80, 100]:
        e = run_test(dict(stale_coef=coef, attract_pct=attract))
